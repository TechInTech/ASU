...
The finished mouth is filled with brown and 3 white teeth
"""
cat3 = turtle.Turtle()
...
cat3.end_fill()
cat3.penup()
cat3.setposition(-6,60)
cat3.setheading(0)
cat3.color("white")
cat3.pendown()
cat3.dot(4)
cat3.penup()
cat3.setposition(0,60)
cat3.setheading(0)
cat3.pendown()
cat3.dot(4)
cat3.penup()
...
It does so by simple goto, left, and right movements.
"""
cat4.penup()            #Raise the pen
cat4.color('lightgreen', 'orange')  #light green border, orange filled
cat4.pensize(10)        #A 10-pixel wide size
cat4.goto(-80,120)      #Empirical value with respect to the physical screen
cat4.pendown()          #Drop the pen, draw
cat4.forward(160)       #Draw a light green 10-pixel wide straight line
cat4.penup()            #lift the pen
cat4.pensize(6)         #Reduce the width to 6 pixels
cat4.begin_fill()       #Filling happens within these movements
cat4.goto(-50,120)      #Offset a little from the left
cat4.pendown()          #Lower the pen, draw
cat4.left(30)           #Turn left 30 degrees
cat4.forward(60)        #Draw a slanted line 60 pixels long
cat4.right(60)          #Turn right 30 degrees from previous left 30 degrees
cat4.forward(60)        #Draw a slanted line 60 pixels long
cat4.end_fill()         #Fill the light green triangle
cat4.penup()            #lift the tail
cat4.color("white")     #Set the pen color to white
cat4.setposition(-300,220)  #Move the turtle to this coordinate
cat4.setheading(0)          #set heading to 0 degree
cat4.pendown()              #drop the tail

#Write a message on screen with Arial font of size 12.
cat4.write("Move the mouse pointer here and left click to close the window.",font=("Arial",12,"bold"))

cat4.hideturtle()       #Hide the turtle
#Click the mouse to close the window
wn.exitonclick()        #Click the mouse to exit.
