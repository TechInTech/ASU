...
def testPatron():
    print("\nTesting a patron")
    p = Patron("Ken")   #Instantiate object Patron with the name set to "Ken"
    print("Expect Ken, 0 books out:", p)  #Constructor responded
    print("Expect Ken:", p.getName())   #call method getName()
    print("Expect 0:", p.getNumBooksOut())  #call method getNumBooksOut()
    p.inc() #Increment NumBooksOut by 1
    print("Expect Ken, 1 books out:", p)
    p.dec() #Decrements NumBooksOut by 1
