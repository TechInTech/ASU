...
class Patron(object):
    ...
    MAX_BOOKS_OUT = 3  #Set maximum books the patron can borrow
        
    def __init__(self, name):   #Constructor function
        self._name = name
        self._numBooksOut = 0

    def __str__(self):      #Test function
    ...
    def getNumBooksOut(self):   #getNumBooksOut() method
        return self._numBooksOut

    def inc(self):  #Increment by 1 method inc()
        """Increments the number of books out."""
        self._numBooksOut += 1

    def dec(self):  #Decrement by 1 method dec()
...
class Book(object):
    ...
    def __init__(self, title, author):  #Constructor function
