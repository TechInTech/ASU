...
public class EX2P6
{
        ...
        public static void main(String[] args)
        {
                ...
                {                      
                        ...
                        {
                                System.out.format("%.3f%n",result1[counter2]);
        ...
        {      
                ...
                switch(op2)
                {
                        ...
                        case 3:
                                   for(counter = 0; counter < op3; counter++)
                                   {
                                           result1[counter] = (((20.0) * counter) - 4.0);
                                   }
                           break;
                        case 4:
                                   for(counter = 0; counter < op3; counter++)
                                   {
                                           result1[counter] = (((12.0) * counter) * (Math.log(counter+1) / Math.log(2.0))) + (100.0 * counter);
                                   }
                          break;
                        case 5:
                                   for(counter = 0; counter < op3; counter++)
