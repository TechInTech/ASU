...
public interface AccountServer {
	...
	/** 
	 *  Create a new account object in the server. if an account already exists with 
	 *  the given name
	 ...
	 *  
		...
		@throws IllegalArgumentException if the account type is invalid or the balance
		@is non-negative. //CST316 TASK 1 CHECKSTYLE FIX
		@return boolean true if the account was created and stored, false otherwise
	*/
	public boolean	newAccount(String type, String name, float balance) 
			throws IllegalArgumentException; //CST316 TASK 1 CHECKSTYLE FIX
